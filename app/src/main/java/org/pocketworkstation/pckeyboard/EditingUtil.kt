...
object EditingUtil {
    ...
    private fun isWordBoundary(singleChar: CharSequence?, wordSeparators: String): Boolean {
        return TextUtils.isEmpty(singleChar) || (singleChar != null && wordSeparators.contains(singleChar))
    }
    ...
    private fun initializeMethodsForReflection() {
        try {
            ...
            sMethodGetSelectedText = InputConnection::class.java.getMethod("getSelectedText", Int::class.javaPrimitiveType)
    ...
    private fun getSelectedText(ic: InputConnection, selStart: Int, selEnd: Int): CharSequence? {
        ...
        if (sMethodGetSelectedText != null) {
            try {
                ...
                // Ignore all exceptions (InvocationTargetException, IllegalArgumentException, IllegalAccessException)
            }
        }
